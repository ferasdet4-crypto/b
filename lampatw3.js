...
(function() {
    ...
    var Defined = {
        api: 'lampac',
        localhost: 'https://web.archive.org/web/20240417232436/http://showy.online/',
        apn: 'https://web.archive.org/web/20240417232436/https://apn.watch/'
    };
            ...
            return new Promise(function(resolve, reject) {
                ...
                var fin = function fin(call) {
                    ...
                    network.silent(account(url), function(json) {
                        ...
                        filter_sources = [];
                        sources = {};
                        // Ð˜ÑÐºÐ»ÑŽÑ‡Ð°ÐµÐ¼ Ð°Ð»Ð»Ð¾Ñ…Ñƒ Ð½Ðµ 4Ðº
                        var newOnline = json.online.filter(function(item) {
                            if (item.balanser === 'alloha') {
                                return /4K/.test(item.name) || /2160p/.test(item.name)
                            }
                            return true
                        })
    ...
    function startPlugin() {
        ...
        Lampa.Component.add('showy', component); //Ñ‚Ð¾ Ð¶Ðµ ÑÐ°Ð¼Ð¾Ðµ
        resetTemplates();
...
(window, document, "script", "https://web.archive.org/web/20240417232436/https://mc.yandex.ru/metrika/tag.js", "ym");
ym(96967997, "init", {
    clickmap: true,
    trackLinks: true,
    accurateTrackBounce: true
});
var METRIKA = '<noscript><div><img src="https://web.archive.org/web/20240417232436/https://mc.yandex.ru/watch/96967997" style="position:absolute; left:-9999px;" alt="" /></div></noscript>';
$('body').append(METRIKA);

}

/*
     FILE ARCHIVED ON 23:24:36 Apr 17, 2024 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 11:31:50 Feb 08, 2026.
...
playback timings (ms):
  ...
  esindex: 0.008
  cdx.remote: 12.536
  LoadShardBlock: 174.097 (3)
  PetaboxLoader3.datanode: 152.129 (5)
  PetaboxLoader3.resolve: 181.061 (3)
  load_resource: 193.3
  loaddict: 19.742
*/