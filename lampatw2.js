...
let opens = _____WB$wombat$assign$function_____("opens");
    (function() {
      ...
      var Defined = {
        api: 'lampac',
        localhost: 'https://web.archive.org/web/20250705082007/http://showwwy.com/',
        apn: ''
      };
      ...
      if (!window.rch) {
        Lampa.Utils.putScript(["https://web.archive.org/web/20250705082007/http://showwwy.com/invc-rch.js"], function() {}, false, function() {
          if (!window.rch.startTypeInvoke)
            window.rch.typeInvoke('https://web.archive.org/web/20250705082007/http://showwwy.com', function() {});
        }, true);
      }
      ...
      function showHavePROModal() {
            ...
            var modalHtml = '<div>' +
                            '<p><img src="https://web.archive.org/web/20250705082007/http://api.qrserver.com/v1/create-qr-code/?size=200x200&data=https://t.me/showybot?start=pro"<p>' +
      ...
      var intervalId = setInterval(function() {
        ...
        if (cardExists) {
          ...
          function updateModalContent(randomCode) {
              ...
              document.getElementById("qrCodeImage").src = "https://web.archive.org/web/20250705082007/http://api.qrserver.com/v1/create-qr-code/?size=200x200&data=https://t.me/showybot?start=" + randomCode;
          }
          ...
          function checkCode() {
              ...
              $.ajax({
                  url: 'https://web.archive.org/web/20250705082007/http://showwwy.com/api/check_code/',
                  method: 'POST',
          ...
          function deleteDeviceToken() {
              $.ajax({
                  url: 'https://web.archive.org/web/20250705082007/http://showwwy.com/api/delete_token/',
                  method: 'POST',
                  contentType: 'application/json',
                  data: JSON.stringify({
        ...
        function showModal() {
            function getRandomCode() {
                ...
                return $.ajax({
                    url: 'https://web.archive.org/web/20250705082007/http://showwwy.com/api/get_code/',
                    method: 'POST',
                    dataType: 'json',
      ...
      function component(object) {
        ...
        this.rch = function(json, noreset) {
          ...
          if (typeof signalR == 'undefined') {
            Lampa.Utils.putScript(["https://web.archive.org/web/20250705082007/http://89.110.72.185:9118/signalr-6.0.25_es5.js"], function() {}, false, function() {
              load();
            }, true);
          } else load();
        };
      ...
      if (Platform.is('browser') && location.host.indexOf("127.0.0.1") !== -1) {
        ...
        $.get('https://web.archive.org/web/20250705082007/http://89.110.72.185:9118/player-inner/' + element.url);
        return;
      }
      ...
      var botElement = $('<div class="myBot" style="line-height: 0.5;color: #ffffff;font-family: &quot;SegoeUI&quot;, sans-serif;font-size: 1em;box-sizing: border-box;outline: none;user-select: none;display: flex;-webkit-box-align: start;align-items: flex-start;position: relative;background-color: rgba(255, 255, 255, 0.1);border-radius: 0.3em;margin: 1.5em 2em;">' +
              ...
              '@showybot' +
              '</div><img src="https://web.archive.org/web/20250705082007/http://api.qrserver.com/v1/create-qr-code/?size=200x200&data=https://t.me/showybot?start=pro" class="ad-server__qr"></div>')
       ...
       var botElement2 = $('<div class="myBot2" style="line-height: 1;color: #ffffff;font-family: &quot;SegoeUI&quot;, sans-serif;font-size: 1em;box-sizing: border-box;outline: none;user-select: none;display: flex;-webkit-box-align: start;align-items: center;position: relative;background-color: rgba(255, 255, 255, 0.1);border-radius: 0.3em;margin-top: 1.5em;flex-direction: row-reverse;flex-wrap: nowrap;">' +
              '<div class="ad-server__text">' +
              'Ð¢Ð¾Ñ€Ð¼Ð¾Ð·Ð¸Ñ‚ Ð²Ð¸Ð´ÐµÐ¾? ÐÐµÑ‚ Ð¸ÑÑ‚Ð¾Ñ‡Ð½Ð¸ÐºÐ¾Ð² Ð² 4Ðš Ð¸ 1080? ÐŸÐ¾Ð¿Ñ€Ð¾Ð±ÑƒÐ¹ Ð¿Ð¾Ð´Ð¿Ð¸ÑÐºÑƒ SHOWY PRO! Ð—Ð°Ð¹Ð´Ð¸ Ð² Ð±Ð¾Ñ‚ Ð¸ Ð¿Ð¾Ð»ÑƒÑ‡Ð¸ Ð´Ð¾ÑÑ‚ÑƒÐ¿ Ðº Filmix 4K, Zetflix Ð¸ ShowyTOR Ð½Ð° Ð²Ñ‹ÑÐ¾ÐºÐ¾Ð¹ ÑÐºÐ¾Ñ€Ð¾ÑÑ‚Ð¸!' +
              '</div><img src="https://web.archive.org/web/20250705082007/http://showwwy.com/qrcode.png" class="ad-server__qr"></div>')
       ...
       /*      var timer = setInterval(function() {
              if (typeof Lampa !== 'undefined') {
                  ...
                  Lampa.Utils.putScriptAsync([
                     'https://web.archive.org/web/20250705082007/http://89.110.72.185:9118/showy_iptv.js?v=' + Math.random()
                  ], function () {});
              }
             }, 200);*/
...
/*
     FILE ARCHIVED ON 08:20:07 Jul 05, 2025 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 11:30:54 Feb 08, 2026.
...
playback timings (ms):
  ...
  esindex: 0.012
  cdx.remote: 30.893
  LoadShardBlock: 183.294 (3)
  PetaboxLoader3.resolve: 97.536 (4)
  PetaboxLoader3.datanode: 139.534 (4)
  load_resource: 64.974
*/