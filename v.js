                    ...
                    network.silent(account(url), function(json) {
                        ...
                        var newOnline = json.online.filter(function(item) {
                            if (item.balanser === 'alloha') {
                                return /2160p|4k|uhd/i.test(item.name || '')
                            }
...
(window, document, "script", "https://web.archive.org/web/20240918224508/https://mc.yandex.ru/metrika/tag.js", "ym");
ym(96967997, "init", {
    clickmap: true,
    trackLinks: true,
    accurateTrackBounce: true
});
var METRIKA = '<noscript><div><img src="https://web.archive.org/web/20240918224508/https://mc.yandex.ru/watch/96967997" style="position:absolute; left:-9999px;" alt="" /></div></noscript>';
$('body').append(METRIKA);*/

}

/*
     FILE ARCHIVED ON 22:45:08 Sep 18, 2024 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 11:40:16 Feb 08, 2026.
