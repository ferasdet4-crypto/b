...
(function() {
  ...
  var Defined = {
    api: 'lampac',
    localhost: 'https://web.archive.org/web/20260202183927/http://89.110.72.185:9118/',
    apn: ''
  };
...
var hostkey = 'https://web.archive.org/web/20260202183927/http://89.110.72.185:9118'.replace('http://', '').replace('https://', '');
...
window.rch_nws[hostkey].typeInvoke = function rchtypeInvoke(host, call) {
  if (!window.rch_nws[hostkey].startTypeInvoke) {
    ...
    if (Lampa.Platform.is('android') || Lampa.Platform.is('tizen')) check(true);
      ...
      net.silent('https://web.archive.org/web/20260202183927/http://89.110.72.185:9118'.indexOf(location.host) >= 0 ? 'https://web.archive.org/web/20260202183927/https://github.com/' : host + '/cors/check', function() {
        check(true);
      }, function() {
        check(false);
      }, false, {
...
window.rch_nws[hostkey].Registry = function RchRegistry(client, startConnection) {
  window.rch_nws[hostkey].typeInvoke('https://web.archive.org/web/20260202183927/http://89.110.72.185:9118', function() {
    ...
    client.on("RchClient", function(rchId, url, data, headers, returnHeaders) {
	  ...
	  function sendResult(uri, html) {
	    $.ajax({
	      url: 'https://web.archive.org/web/20260202183927/http://89.110.72.185:9118/rch/' + uri + '?id=' + rchId,
	      type: 'POST',
	      data: html,
	      async: true,
	      cache: false,
  ...
  function rchRun(json, call) {
    if (typeof NativeWsClient == 'undefined') {
      Lampa.Utils.putScript(["https://web.archive.org/web/20260202183927/http://89.110.72.185:9118/js/nws-client-es5.js?v18112025"], function() {}, false, function() {
        rchInvoke(json, call);
      }, true);
    } else {
      rchInvoke(json, call);
  ...
  function showHavePROModal() {
            ...
            var modalHtml = '<div>' +
                            '<p><img src="https://web.archive.org/web/20260202183927/http://api.qrserver.com/v1/create-qr-code/?size=200x200&data=https://t.me/showybot?start=pro"<p>' +
                            '<p>Ð’Ñ‹ Ð¾Ñ‚ÐºÑ€Ñ‹Ð²Ð°ÐµÑ‚Ðµ Ð±ÐµÑÐ¿Ð»Ð°Ñ‚Ð½Ñ‹Ð¹ Ð¿Ð»Ð°Ð³Ð¸Ð½, Ð½Ð¾ Ñƒ Ð²Ð°Ñ Ð¾Ð¿Ð»Ð°Ñ‡ÐµÐ½Ð° PRO Ð¿Ð¾Ð´Ð¿Ð¸ÑÐºÐ°. Ð£Ð´Ð°Ð»Ð¸Ñ‚Ðµ ÑÑ‚Ð¾Ñ‚ Ð¿Ð»Ð°Ð³Ð¸Ð½, Ð·Ð°Ñ‚ÐµÐ¼ Ð½Ð°ÑÑ‚Ñ€Ð¾Ð¹Ñ‚Ðµ ÑƒÑÑ‚Ñ€Ð¾Ð¹ÑÑ‚Ð²Ð¾ Ð¿Ð¾ Ð¸Ð½ÑÑ‚Ñ€ÑƒÐºÑ†Ð¸Ð¸, ÐºÐ¾Ñ‚Ð¾Ñ€Ð°Ñ Ð¿Ñ€Ð¸ÑˆÐ»Ð° Ð¿Ð¾ÑÐ»Ðµ Ð¾Ð¿Ð»Ð°Ñ‚Ñ‹, Ð»Ð¸Ð±Ð¾ Ð¿Ð¾ ÑÑÑ‹Ð»ÐºÐµ Ñ QR-ÐºÐ¾Ð´Ð°</p>' +
                            '</div>';
      ...
      var intervalId = setInterval(function() {
        ...
        if (cardExists) {
            ...
            if (!playerVideoExists && element && !modalExists) {
                if (element.innerText === 'ÐÐµ Ð°Ð²Ñ‚Ð¾Ñ€Ð¸Ð·Ð¾Ð²Ð°Ð½') {
                    ...
                    showModal();
                } else if (element.innerText === 'Ð£ Ð²Ð°Ñ ÐµÑÑ‚ÑŒ ÐŸÐ Ðž') {
                    isCodeObtained = false;
                    showHavePROModal();
                }
            }
          ...
          function updateModalContent(randomCode) {
              ...
              document.getElementById("qrCodeImage").src = "https://web.archive.org/web/20260202183927/http://api.qrserver.com/v1/create-qr-code/?size=200x200&data=https://t.me/showybot?start=" + randomCode;
          }
          ...
          function checkCode() {
              ...
              $.ajax({
                  url: 'https://web.archive.org/web/20260202183927/http://showwwy.com/api/check_code/',
                  method: 'POST',
          ...
          function deleteDeviceToken() {
              $.ajax({
                  url: 'https://web.archive.org/web/20260202183927/http://showwwy.com/api/delete_token/',
                  method: 'POST',
                  contentType: 'application/json',
                  data: JSON.stringify({
        ...
        function showModal() {
            function getRandomCode() {
                ...
                return $.ajax({
                    url: 'https://web.archive.org/web/20260202183927/http://showwwy.com/api/get_code/',
                    method: 'POST',
                    dataType: 'json',
            ...
            var modalHtml = '<div>' +
                                '<img id="qrCodeImage"/>' +
                                '<p>Ð”Ð»Ñ Ð¿Ñ€Ð¾ÑÐ¼Ð¾Ñ‚Ñ€Ð° Ñ‡ÐµÑ€ÐµÐ· Ð¾Ð½Ð»Ð°Ð¹Ð½ Ð¿Ð»Ð°Ð³Ð¸Ð½ Showy Ñ‚Ñ€ÐµÐ±ÑƒÐµÑ‚ÑÑ Ð°Ð²Ñ‚Ð¾Ñ€Ð¸Ð·Ð°Ñ†Ð¸Ñ, Ð¿Ð¾Ð¶Ð°Ð»ÑƒÐ¹ÑÑ‚Ð° Ð¾Ñ‚ÑÐºÐ°Ð½Ð¸Ñ€ÑƒÐ¹Ñ‚Ðµ QR Ð¸Ð»Ð¸ Ð²Ð²ÐµÐ´Ð¸Ñ‚Ðµ ÐºÐ¾Ð´ Ð² Ñ‚ÐµÐ»ÐµÐ³Ñ€Ð°Ð¼-Ð±Ð¾Ñ‚Ðµ @showybot Ð¸Ð»Ð¸ Ð¿Ð¾ ÑÑÑ‹Ð»ÐºÐµ t.me/showybot</p>' +
        ...
        function checkCodeInterval() {
            ...
            }, 3000); // ÐŸÑ€Ð¾Ð²ÐµÑ€ÐºÐ° ÐºÐ°Ð¶Ð´Ñ‹Ðµ 3 ÑÐµÐºÑƒÐ½Ð´Ñ‹
        }
  ...
  function component(object) {
    ...
    if (balansers_with_search == undefined) {
      ...
      network.silent(account('https://web.archive.org/web/20260202183927/http://89.110.72.185:9118/lite/withsearch'), function(json) {
  ...
  if (false) {
    if (Platform.is('browser') && location.host.indexOf("127.0.0.1") !== -1) {
      Noty.show('Ð’Ð¸Ð´ÐµÐ¾ Ð¾Ñ‚ÐºÑ€Ñ‹Ñ‚Ð¾ Ð² playerInner', {time: 3000});
      $.get('https://web.archive.org/web/20260202183927/http://89.110.72.185:9118/player-inner/' + element.url);
      return;
    }
    ...
    if (true && Platform.is('browser') && location.host.indexOf("127.0.0.1") !== -1)
      Noty.show('Ð’Ð½ÐµÑˆÐ½Ð¸Ð¹ Ð¿Ð»ÐµÐµÑ€ Ð¼Ð¾Ð¶Ð½Ð¾ ÑƒÐºÐ°Ð·Ð°Ñ‚ÑŒ Ð² init.conf (playerInner)', {time: 3000});
    Player.play(element);
  }
}
  ...
  function startPlugin() {
    ...
    var button = "<div class=\"full-start__button selector view--online_showy showy--button\" data-subtitle=\"".concat(manifst.name, " v").concat(manifst.version, "\">\n        <svg xmlns=\"http://www.w3.org/2000/svg\" version=\"1.1\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" viewBox=\"0 0 392.697 392.697\" xml:space=\"preserve\">\n            <path d=\"M21.837,83.419l36.496,16.678L227.72,19.886c1.229-0.592,2.002-1.846,1.98-3.209c-0.021-1.365-0.834-2.592-2.082-3.145\n                L197.766,0.3c-0.903-0.4-1.933-0.4-2.837,0L21.873,77.036c-1.259,0.559-2.073,1.803-2.081,3.18\n                C19.784,81.593,20.584,82.847,21.837,83.419z\" fill=\"currentColor\"></path>\n            <path d=\"M185.689,177.261l-64.988-30.01v91.617c0,0.856-0.44,1.655-1.167,2.114c-0.406,0.257-0.869,0.386-1.333,0.386\n                c-0.368,0-0.736-0.082-1.079-0.244l-68.874-32.625c-0.869-0.416-1.421-1.293-1.421-2.256v-92.229L6.804,95.5\n                c-1.083-0.496-2.344-0.406-3.347,0.238c-1.002,0.645-1.608,1.754-1.608,2.944v208.744c0,1.371,0.799,2.615,2.045,3.185\n                l178.886,81.768c0.464,0.211,0.96,0.315,1.455,0.315c0.661,0,1.318-0.188,1.892-0.555c1.002-0.645,1.608-1.754,1.608-2.945\n                V180.445C187.735,179.076,186.936,177.831,185.689,177.261z\" fill=\"currentColor\"></path>\n            <path d=\"M389.24,95.74c-1.002-0.644-2.264-0.732-3.347-0.238l-178.876,81.76c-1.246,0.57-2.045,1.814-2.045,3.185v208.751\n                c0,1.191,0.606,2.302,1.608,2.945c0.572,0.367,1.23,0.555,1.892,0.555c0.495,0,0.991-0.104,1.455-0.315l178.876-81.768\n                c1.246-0.568,2.045-1.813,2.045-3.185V98.685C390.849,97.494,390.242,96.384,389.24,95.74z\" fill=\"currentColor\"></path>\n            <path d=\"M372.915,80.216c-0.009-1.377-0.823-2.621-2.082-3.18l-60.182-26.681c-0.938-0.418-2.013-0.399-2.938,0.045\n                l-173.755,82.992l60.933,29.117c0.462,0.211,0.958,0.316,1.455,0.316s0.993-0.105,1.455-0.316l173.066-79.092\n                C372.122,82.847,372.923,81.593,372.915,80.216z\" fill=\"currentColor\"></path>\n        </svg>\n\n        <span>#{title_online}</span>\n    </div>"); // Ð½ÑƒÐ¶Ð½Ð° Ð·Ð°Ð³Ð»ÑƒÑˆÐºÐ°, Ð° Ñ‚Ð¾ Ð¿Ñ€Ð¸ ÑÑ‚Ñ€Ð°Ñ‚Ðµ Ð»Ð°Ð¼Ð¿Ñ‹ Ð³Ð¾Ð²Ð¾Ñ€Ð¸Ñ‚ Ð¿ÑƒÑÑ‚Ð¾
      ...
      var botElement = $('<div class="myBot" style="line-height: 0.5;color: #ffffff;font-family: &quot;SegoeUI&quot;, sans-serif;font-size: 1em;box-sizing: border-box;outline: none;user-select: none;display: flex;-webkit-box-align: start;align-items: flex-start;position: relative;background-color: rgba(255, 255, 255, 0.1);border-radius: 0.3em;margin: 1.5em 2em;">' +
              ...
              'Ð¢Ð¾Ñ€Ð¼Ð¾Ð·Ð¸Ñ‚ Ð²Ð¸Ð´ÐµÐ¾? ÐÐµÑ‚ Ð¸ÑÑ‚Ð¾Ñ‡Ð½Ð¸ÐºÐ¾Ð² Ð² 4Ðš Ð¸ 1080? ÐŸÐ¾Ð¿Ñ€Ð¾Ð±ÑƒÐ¹ Ð¿Ð¾Ð´Ð¿Ð¸ÑÐºÑƒ SHOWY PRO! Ð—Ð°Ð¹Ð´Ð¸ Ð² Ð±Ð¾Ñ‚ Ð¸ Ð¿Ð¾Ð»ÑƒÑ‡Ð¸ Ð´Ð¾ÑÑ‚ÑƒÐ¿ Ðº Filmix 4K, Zetflix Ð¸ ShowyTOR Ð½Ð° Ð²Ñ‹ÑÐ¾ÐºÐ¾Ð¹ ÑÐºÐ¾Ñ€Ð¾ÑÑ‚Ð¸!' +
              '</div><div class="ad-server__label">' +
              '@showybot' +
              '</div><img src="https://web.archive.org/web/20260202183927/http://api.qrserver.com/v1/create-qr-code/?size=200x200&data=https://t.me/showybot?start=pro" class="ad-server__qr"></div>')
       ...
       var botElement2 = $('<div class="myBot2" style="line-height: 1;color: #ffffff;font-family: &quot;SegoeUI&quot;, sans-serif;font-size: 1em;box-sizing: border-box;outline: none;user-select: none;display: flex;-webkit-box-align: start;align-items: center;position: relative;background-color: rgba(255, 255, 255, 0.1);border-radius: 0.3em;margin-top: 1.5em;flex-direction: row-reverse;flex-wrap: nowrap;">' +
              '<div class="ad-server__text">' +
              'Ð¢Ð¾Ñ€Ð¼Ð¾Ð·Ð¸Ñ‚ Ð²Ð¸Ð´ÐµÐ¾? ÐÐµÑ‚ Ð¸ÑÑ‚Ð¾Ñ‡Ð½Ð¸ÐºÐ¾Ð² Ð² 4Ðš Ð¸ 1080? ÐŸÐ¾Ð¿Ñ€Ð¾Ð±ÑƒÐ¹ Ð¿Ð¾Ð´Ð¿Ð¸ÑÐºÑƒ SHOWY PRO! Ð—Ð°Ð¹Ð´Ð¸ Ð² Ð±Ð¾Ñ‚ Ð¸ Ð¿Ð¾Ð»ÑƒÑ‡Ð¸ Ð´Ð¾ÑÑ‚ÑƒÐ¿ Ðº Filmix 4K, Zetflix Ð¸ ShowyTOR Ð½Ð° Ð²Ñ‹ÑÐ¾ÐºÐ¾Ð¹ ÑÐºÐ¾Ñ€Ð¾ÑÑ‚Ð¸!' +
              '</div><img src="https://web.archive.org/web/20260202183927/http://showwwy.com/qrcode.png" class="ad-server__qr"></div>')
        ...
        Lampa.Storage.listener.follow('change', function (event) {
                ...
                if (document.querySelector('.online-prestige-watched') !== null) {
                    ...
                    if (Lampa.Activity.active().component == 'full') {
    Â Â Â                 var add_ads2 = setInterval(function() {

    Â Â Â Â Â Â Â              var titleText = $('.selectbox__title').text(); // Ð¡Ð¾Ð·Ð´Ð°ÐµÐ¼ Ð¿ÐµÑ€ÐµÐ¼ÐµÐ½Ð½ÑƒÑŽ Ð´Ð»Ñ Ñ‚ÐµÐºÑÑ‚Ð°

                        if (titleText.length && titleText === 'Ð˜ÑÑ‚Ð¾Ñ‡Ð½Ð¸Ðº' && Lampa.Activity.active().component === 'full') { // ÐŸÑ€Ð¾Ð²ÐµÑ€ÑÐµÐ¼ Ð´Ð»Ð¸Ð½Ñƒ Ð¿ÐµÑ€ÐµÐ¼ÐµÐ½Ð½Ð¾Ð¹ Ð¸ ÐµÐµ Ð·Ð½Ð°Ñ‡ÐµÐ½Ð¸Ðµ
                          //  $('.selectbox__title').after(botElement2); // Ð’ÑÑ‚Ð°Ð²Ð»ÑÐµÐ¼ ÑÐ»ÐµÐ¼ÐµÐ½Ñ‚ Ð¿Ð¾ÑÐ»Ðµ Ð·Ð°Ð³Ð¾Ð»Ð¾Ð²ÐºÐ°
       ...
       /*      var timer = setInterval(function() {
              if (typeof Lampa !== 'undefined') {
                  ...
                  Lampa.Utils.putScriptAsync([
                     'https://web.archive.org/web/20260202183927/http://89.110.72.185:9118/showy_iptv.js?v=' + Math.random()
                  ], function () {});
              }
             }, 200);*/
...
/*
     FILE ARCHIVED ON 18:39:27 Feb 02, 2026 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 11:23:23 Feb 08, 2026.
...
playback timings (ms):
  ...
  esindex: 0.009
  cdx.remote: 18.268
  LoadShardBlock: 201.182 (3)
  PetaboxLoader3.datanode: 127.516 (4)
  PetaboxLoader3.resolve: 201.0 (2)
  load_resource: 176.632
*/